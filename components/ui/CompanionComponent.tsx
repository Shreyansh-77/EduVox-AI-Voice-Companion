...
const CompanionComponent = ({ companionId, subject, topic, name, userName, userImage, style, voice }: CompanionComponentProps) => {
    ...
    useEffect(() => {
        ...
        const onError = (error: Error) => console.error("Error in companion call:", error);
        ...
        <section className='flex flex-col h-[70vh]'>
            <section className='flex gap-8 max-sm:flex-col'>
                ...
                <div className='user-section'>
                    ...
                    <button className={cn('rounded-lg py-2 cursor-pointor transistion-colors w-full text-white bg-black', callStatus === CallStatus.ACTIVE ? 'bg-red-700' : 'bg-primary', callStatus === CallStatus.CONNECTING && 'animate-pulse')} onClick={callStatus === CallStatus.ACTIVE ? handleDisconnect : handleCall}>
            ...
            <section className='transcript'>
                <div className='transcript-message no-scorllbar'>
